...
class PowerSines(scrapy.Spider):
  ...
  def parse(self, response):
    ...
    for measurement in jresp["measurements"]:
      mdict = {db_col_mapping[value["ParamName"]] : float(value["Value"]) for value in measurement["Values"]}
      mdict["rdate"] = measurement["TimeStart"]
      marr.append(mdict)
